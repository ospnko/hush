...
class HushBuilderTest extends TestCase
{
    public function testBlockAllParams(): void
    {
        ...
        $this->assertEquals($expectedResult, $result->renderMinimized());
    }
    ...
    public function testInputFileAllParams(): void
    {
        ...
        $result = $hush->inputFile(
            ...
            asyncUrl: '/products',
            upperContent: fn (HushBuilder $hush) => $hush->text('Image here')->renderMinimized(),
            isMultiple: true,
            errors: ['Some error', 'Another error'],
            attributes: ['class' => 'some-class', 'id' => 'some-id'],
    ...
    public function testPagination(): void
    {
        ...
        $expectedResult = <<<HTML
        <div class="pagination"><a href="/dashboard/products?sort_by=name&page=1">1</a><a href="#" class="current">2</a><a href="/dashboard/products?sort_by=name&page=3">3</a><a href="/dashboard/products?sort_by=name&page=4">4</a><a href="/dashboard/products?sort_by=name&page=5">5</a><a href="#">...</a><a href="/dashboard/products?sort_by=name&page=14">14</a><a href="/dashboard/products?sort_by=name&page=15">15</a></div>
        HTML;
